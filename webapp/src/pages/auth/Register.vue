    ...
    <form  class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" v-on:submit.prevent >
      ...
      <div class="mb-6">
       ...
       <div class="mb-6">
        ...
        <input v-model="password" class="shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="password" id="password" type="password" placeholder="رقم الجوال">
        <p class="text-red-500 text-xs italic"></p>
      </div>
...
export default{
    setup(){
        ...
        const phone = ref("");
        function submit(){
            console.log(name.value, password.value, phone.value);
        }
        return {
            name,
            password,
