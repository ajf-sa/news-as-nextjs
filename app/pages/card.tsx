                    ...
                    <section className="container mx-auto lg:mt-20 transform duration-500 p-10 mt-10">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br flex items-center justify-center from-cyan-400 to-cyan-900 mb-8">
                            <svg width="32" height="32" fill="none" viewBox="0 0 32 32">
                                <g clipPath="url(#build-anything_svg__clip0)">
                                    <g filter="url(#build-anything_svg__filter0_d)">
                                        <path fill="#FDBA74" fillRule="evenodd"
                                            d="M25.414 6.586a2 2 0 010 2.828l-20 20a2 2 0 11-2.828-2.828l20-20a2 2 0 012.828 0z" clipRule="evenodd">
                                        </path>
                                    </g>
                        ...
                        <p>
                            <a className="github-button" href="https://github.com/hasinhayder/tailwind-cards" data-size="large" data-show-count="true" aria-label="Star hasinhayder/tailwind-cards on GitHub">&nbsp;&nbsp;Download From
                            Github
                            </a>
                            <span>&nbsp;&nbsp;</span>
                            <a className="github-button" href="https://github.com/HasinHayder" data-size="large" aria-label="Follow @HasinHayder on GitHub">Follow @HasinHayder</a>
                        </p>
                        <p className="text-gray-300">
                            * Artworks by
            <a href="https://www.mathiole.com/" rel={"nofollow"} >Matheus Lopes</a>
                        </p>
                    </section>
                    ...
                    <section className="container mx-auto p-10 md:p-20 transform duration-500">
                        <article className="flex flex-wrap md:flex-nowrap shadow-lg mx-auto max-w-xl ">
                            <img className="w-full md:w-40 h-auto" src="https://weandthecolor.com/wp-content/uploads/2012/03/A-Way-Out-Illustration-by-Matheus-Lopes-4563464.jpg" alt="" />
                    ...
                    <section className="container mx-auto p-10 md:p-20 transform duration-500">
                        <section className="shadow-lg mx-auto max-w-sm ">
                            <img className="w-full h-auto" src="https://weandthecolor.com/wp-content/uploads/2012/03/Alternate-Ending-Illustration-by-Matheus-Lopes-3454646.jpg" alt="" />
                    ...
                    <section className="container mx-auto p-10 md:p-20 transform duration-500">
                        <article className="shadow-lg mx-auto relative max-w-sm">
                            <img className="w-full h-auto" src="https://weandthecolor.com/wp-content/uploads/2012/03/Colorphobia-Illustration-by-Matheus-Lopes-34645646.jpg" alt="" />
                            <span className="absolute right-4 top-4 bg-gray-600 text-white rounded-md p-1 pl-4 pr-4 font-semibold">Matheus
        Lopes</span>
                            <div className="p-7 my-auto pb-10 ">
                    ...
                    <section className="container mx-auto p-10 md:p-20 transform duration-500">
                        <article className="shadow-lg mx-auto relative max-w-md group cursor-pointer">
                            <div className="overflow-hidden">
                                <img className="w-full h-auto transform hover:scale-110 duration-500" src="https://www.artisticmoods.com/wp-content/uploads/tropicalia_by_mathiole-d31lvne.jpg" alt="" />
                            </div>
                    ...
                    <section className="container mx-auto p-10 md:p-20 antialiased ">
                        <article className=" flex flex-wrap md:flex-nowrap shadow-lg mx-auto max-w-3xl group cursor-pointer transform duration-500 hover:-translate-y-1">
                            <img className="w-full md:w-52" src="https://i.ibb.co/Kr4b0zJ/152013403-10158311889099633-8423107287930246533-o.jpg" alt="" />
                            <div className="">
                    ...
                    <section className="container mx-auto p-10 md:p-20 antialiased">
                        <article className="mx-auto max-w-md w-full sm:w-1/2 lg:w-1/3 py-6 px-3 cursor-pointer transform duration-500 hover:-translate-y-1">
                            <div className="bg-white shadow-xl rounded-lg overflow-hidden">
                                <div className="bg-cover bg-center h-80 p-4" style={{ backgroundImage: `url("https://images.squarespace-cdn.com/content/v1/58dd442dbebafb88160c6929/1524859464600-90ZK15JJC3N47IZSR3MY/ke17ZwdGBToddI8pDm48kPvdHwxe8vxmYnjZvCzAU61Zw-zPPgdn4jUwVcJE1ZvWQUxwkmyExglNqGp0IvTJZUJFbgE-7XRK3dMEBRBhUpwxsJYjeBOStWfhZBaQGTlDOVYbSZjX976lCUHHLPdHUlrmON35exl807wLzw9VMGw/visit03.jpg?format=800w)` }}>
                        ...
                        <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10">
                            <article className="mx-auto group w-full shadow-2xl max-w-md pb-8 rounded-b-2xl transform duration-500 hover:-translate-y-2 cursor-pointer">
                                ...
                                <div className="my-5 p-4 flex">
                                    <img className="w-10 h-10 rounded-full " src="https://images.generated.photos/6iXTm1iVJzoRHx2m_uKRp222qguutiVLOUVlTe_l3iA/rs:fit:256:256/Z3M6Ly9nZW5lcmF0/ZWQtcGhvdG9zL3Yz/XzAwMjMwNDYuanBn.jpg" alt="" />
                                    <div className="w-full flex justify-end space-x-1">
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1604537466573-5e94508fd243?ixid=MXwxMjA3fDF8MHxzZWFyY2h8MXx8bGFuZHNjYXBlfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTZ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1433838552652-f9a46b332c40?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTJ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                                    </div>
                                </div>
                            ...
                            <article className="mx-auto group w-full shadow-2xl max-w-md pb-8 rounded-b-2xl transform duration-500 hover:-translate-y-2 cursor-pointer group">
                                <section className="content bg-cover bg-center h-64 rounded-2xl" style={{ backgroundImage: `url(https://images.unsplash.com/photo-1433838552652-f9a46b332c40?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTJ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=100)` }}>
                                    <div className="flex items-end w-full h-full bg-black bg-opacity-20 text-white text-sm font-bold  p-4 rounded-2xl">
                                        <div className="w-1/2 flex items-center">
                                            <svg className="w-6 h-6 mr-2 " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                ...
                                <div className="my-5 p-4 flex">
                                    <img className="w-10 h-10 rounded-full " src="https://images.generated.photos/YBzd3k0_Ry-XxOVS_wa0Wkxp4Mpk2w1hhRPllYA58yQ/rs:fit:256:256/Z3M6Ly9nZW5lcmF0/ZWQtcGhvdG9zL3Yz/XzAzNDY2MjcuanBn.jpg" alt="" />
                                    <div className="w-full flex justify-end space-x-1">
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1604537466573-5e94508fd243?ixid=MXwxMjA3fDF8MHxzZWFyY2h8MXx8bGFuZHNjYXBlfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTZ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1433838552652-f9a46b332c40?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTJ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                            ...
                            <article className="mx-auto group w-full shadow-2xl max-w-md pb-8 rounded-b-2xl transform duration-500 hover:-translate-y-2 cursor-pointer">
                                <section className="content bg-cover bg-center h-64 rounded-2xl" style={{ backgroundImage: `url(https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTZ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=100)` }}>
                                    <div className="flex items-end w-full h-full bg-black bg-opacity-20 text-white text-sm font-bold  p-4 rounded-2xl">
                                        <div className="w-1/2 flex items-center">
                                            <svg className="w-6 h-6 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                ...
                                <div className="my-5 p-4 flex">
                                    <img className="w-10 h-10 rounded-full " src="https://images.generated.photos/y99vaViCjDei2ojQZEUIZkbp2d7FiR_n8alwPHMPSMA/rs:fit:256:256/Z3M6Ly9nZW5lcmF0/ZWQtcGhvdG9zL3Yz/XzAyNDI0MzcuanBn.jpg" alt="" />
                                    <div className="w-full flex justify-end space-x-1">
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1604537466573-5e94508fd243?ixid=MXwxMjA3fDF8MHxzZWFyY2h8MXx8bGFuZHNjYXBlfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTZ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1433838552652-f9a46b332c40?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTJ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                            ...
                            <article className="mx-auto group w-full shadow-2xl max-w-md pb-8 rounded-b-2xl transform duration-500 hover:-translate-y-2 cursor-pointer">
                                ...
                                <div className="my-5 p-4 flex">
                                    <img className="w-10 h-10 rounded-full " src="https://images.generated.photos/dR0k2Wztn0AVEncDXA1tnOmTVMR9-QM7yTWbKSM67KU/rs:fit:256:256/Z3M6Ly9nZW5lcmF0/ZWQtcGhvdG9zL3Yz/XzA5MDc2NDYuanBn.jpg" alt="" />
                                    <div className="w-full flex justify-end space-x-1">
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1604537466573-5e94508fd243?ixid=MXwxMjA3fDF8MHxzZWFyY2h8MXx8bGFuZHNjYXBlfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTZ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                                        <img className="w-10 h-10 rounded-md" src="https://images.unsplash.com/photo-1433838552652-f9a46b332c40?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTJ8fGxhbmRzY2FwZXxlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=100" alt="" />
                        ...
                        <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10">
                            <article className="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
                                <div className="max-h-125 overflow-hidden">
                                    <img className="transform duration-300 group-hover:scale-110" src="https://images.unsplash.com/photo-1615319532762-b4ccc69e5abf?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTA3fHxsYW5kc2NhcGV8ZW58MHx8MHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=100" alt="" />
                                </div>
                                <div className="flex justify-between my-5 ">
                                    <div className="text-orange-500 text-base font-semibold">California</div>
                                    <div className="text-base text-right"><span className="font-bold">87</span>/Day</div>
                                </div>
                                <h2 className="font-bold text-2xl">Photo by <a target="_blank" href="https://unsplash.com/photos/YgCmUdaFkHo">Drew
            Dao</a> </h2>
                                <div className="flex justify-between items-center mt-3 ">
                                    <div className="text-base uppercase font-semibold text-gray-500">15 Days Tour</div>
                            ...
                            <article className="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
                                <div className="max-h-125 overflow-hidden">
                                    <img className="transform duration-300 group-hover:scale-110" src="https://images.unsplash.com/photo-1562981943-dda9d14477f0?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTE4fHxsYW5kc2NhcGV8ZW58MHx8MHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=100" alt="" />
                                </div>
                                <div className="flex justify-between my-5 ">
                                    <div className="text-orange-500 text-base font-semibold">San Diego, California</div>
                                    <div className="text-base text-right"><span className="font-bold">75</span>/Day</div>
                                </div>
                                <h2 className="font-bold text-2xl">Photo by <a target="_blank" href="https://unsplash.com/photos/xYdxw6C3tSA">Trent
            Haaland</a></h2>
                                <div className="flex justify-between items-center mt-3 ">
                                    <div className="text-base uppercase font-semibold text-gray-500">21 Days Tour</div>
                                    <div className="text-base text-right">
                                        <div className="flex">
                                            <svg className="w-4 h-4 mx-px fill-current text-orange-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14">
                                                <path
                            ...
                            <article className="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
                                <div className="max-h-125 overflow-hidden">
                                    <img className="transform duration-300 group-hover:scale-110" src="https://images.unsplash.com/photo-1475066392170-59d55d96fe51?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=100" alt="" />
                                </div>
                                <div className="flex justify-between my-5 ">
                                    <div className="text-orange-500 text-base font-semibold">Aksla Viewpoint, Alesund, Norway</div>
                                    <div className="text-base text-right"><span className="font-bold">176</span>/Day</div>
                                </div>
                                <h2 className="font-bold text-2xl">Photo by <a target="_blank" href="https://unsplash.com/photos/3-MftKobVtg">Jarand
            K. Løkeland</a></h2>
                                <div className="flex justify-between items-center mt-3 ">
                                    <div className="text-base uppercase font-semibold text-gray-500">24 Days Tour</div>
                                    <div className="text-base text-right">
                                        <div className="flex">
                                            <svg className="w-4 h-4 mx-px fill-current text-orange-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14">
                                                <path
                            ...
                            <article className="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
                                <div className="max-h-125 overflow-hidden">
                                    <img className="transform duration-300 group-hover:scale-110" src="https://images.unsplash.com/photo-1459787915554-b34915863013?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=887&q=100" alt="" />
                                </div>
                                <div className="flex justify-between my-5 ">
                                    <div className="text-orange-500 text-base font-semibold">Dubai, United Arab Emirates</div>
                                    <div className="text-base text-right"><span className="font-bold">120</span>/Day</div>
                                </div>
                                <h2 className="font-bold text-2xl">Photo by <a target="_blank" href="https://unsplash.com/photos/CwJb7ly-iqc">Ashim
            D'Silva</a></h2>
                                <div className="flex justify-between items-center mt-3 ">
                                    <div className="text-base uppercase font-semibold text-gray-500">10 Days Tour</div>
                                    <div className="text-base text-right">
                                        <div className="flex">
                                            <svg className="w-4 h-4 mx-px fill-current text-orange-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14">
                                                <path
        ...
        Category Page by Faria Anzum</a>
                    ...
                    <section className="container mx-auto p-10 md:py-20 px-0 md:p-10 md:px-0">
                        <section className="p-5 md:p-0 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10">
                            <article className="p-10 min-h-116 max-w-xl w-full bg-gray-200 rounded-xl text-gray-600 transform duration-500 hover:-translate-y-1 cursor-pointer">
                                <h1 className="mt-5 text-2xl md:text-3xl font-light leading-snug min-h-33">One small step for man one giant leap for mankind
                </h1>
                                <div className="mt-20">
                                ...
                                <div className="mt-16 flex justify-between">
                                    ...
                                    <span className="p-3  border-2 border-gray-500 rounded-md text-base hover:bg-black hover:border-gray-200 cursor-pointer hover:text-white ">Paid
            Membership</span>
                                </div>
                            </article>
              ...
              Membership</span>
                            ...
                            <article className="p-10 min-h-116 max-w-3xl w-full bg-purple-600 rounded-xl text-gray-100 xl:col-span-2 transform duration-500 hover:-translate-y-1 cursor-pointer">
                                <h1 className="mt-5 text-5xl font-light text-gray-100 leading-snug  min-h-33">One small step for man one giant leap for mankind
                </h1>
                                <div className="mt-20">
                                    <span className="text-xl">Moonlanding - </span>
                                    <span className="font-bold text-xl">Neil Armstrong</span>
            ...
            Membership</span>
                            ...
                            <article className="p-10 min-h-116 max-w-3xl w-full rounded-xl text-gray-100 xl:col-span-2 bg-center bg-cover transform duration-500 hover:-translate-y-1 cursor-pointer" style={{ backgroundImage: `url(https://images.unsplash.com/photo-1559827291-72ee739d0d9a?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80)` }}>
                                ...
                                <div className="mt-16 flex justify-between ">
                                    ...
                                    <span className="p-3 px-5 bg-gray-200  rounded-md text-base hover:bg-orange-600 cursor-pointer hover:text-white text-black ">Paid
            Membership</span>
                                </div>
                            </article>
            ...
            Membership</span>
                            ...
                            <article className="flex flex-col-reverse p-10 min-h-116 max-w-xl w-full bg-orange-600 rounded-xl text-gray-100 transform duration-500 hover:-translate-y-1 cursor-pointer">
                                <h1 className="mt-10 text-3xl text-gray-100 leading-snug  min-h-33">One small step for man one giant leap for mankind
                </h1>
                                <div className="mt-24">
                                    <span className="text-xl">Moonlanding - </span>
                                    <span className="font-bold text-xl">Neil Armstrong</span>
                        ...
                        <section className="p-5 md:p-0 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10 items-start ">
                            <article className="relative shadow-2xl max-w-lg w-full transform duration-500 hover:-translate-y-2 cursor-pointer rounded-md">
                                <div className="flex absolute right-0 top-0 w-10 h-10 bg-blue-600 text-gray-100">
                                    ...
                                    <div className="bg-no-repeat bg-center overflow-hidden mt-10 min-h-96" style={{ backgroundImage: `url('svgs/blob-blue.svg')` }}>
                                        <img className="mx-auto p-5" src="https://www.dropbox.com/s/mlor33hzk73rh0c/x14423.png?dl=1" alt="" />
                                    </div>
                                ...
                                <article className="relative shadow-2xl max-w-lg w-full transform duration-500 hover:-translate-y-2 cursor-pointer rounded-md">
                                    <div className="flex absolute left-0 top-0 w-10 h-10 bg-orange-600 text-gray-100">
                                        ...
                                        <div className="bg-no-repeat bg-center overflow-hidden mt-10 min-h-96" style={{ backgroundImage: `url('svgs/blob-blue.svg')` }}>
                                            <img className="mx-auto p-5" src="https://www.dropbox.com/s/1fav310i2eqkdz8/tool2.png?dl=1" alt="" />
                                        </div>
                                        <div className="p-8 mb-10 mt-2">
                                    ...
                                    <article className="relative shadow-2xl max-w-lg w-full transform duration-500 hover:-translate-y-2 cursor-pointer rounded-md">
                                        <div className="flex absolute right-0 -mt-10 top-1/2 w-10 h-10 bg-blue-600 text-gray-100">
                                            ...
                                            <div className="bg-no-repeat bg-center overflow-hidden mt-10 min-h-96" style={{ backgroundImage: `url('svgs/blob-blue.svg')` }}>
                                                <img className="mx-auto p-5" src="https://www.dropbox.com/s/8ymeus1n9k9bhpd/y16625.png?dl=1" alt="" />
                                            </div>
                                            <div className="p-8 mb-10 mt-2">
                                        ...
                                        <article className="relative shadow-2xl max-w-lg w-full transform duration-500 hover:-translate-y-2 cursor-pointer rounded-md">
                                            <div className="flex absolute left-0 -mt-10 top-1/2 w-10 h-10 bg-orange-600 text-gray-100">
                                                ...
                                                <div className="bg-no-repeat bg-center overflow-hidden mt-10 min-h-96" style={{ backgroundImage: `url('svgs/blob-blue.svg' )` }}>
                                                    <img className="mx-auto p-5" src="https://www.dropbox.com/s/ykdro56f2qltxys/hh2774663-87776.png?dl=1" alt="" />
                                                </div>
                                                <div className="p-8 mb-10 mt-2">
                                        ...
                                        <section className="p-5 md:p-0 xl:grid xl:grid-cols-12 xl:grid-rows-6 xl:h-200">
                                            <section className="row-start-1 row-end-5 col-start-1 col-end-9 bg-orange-100">
                                                <article className="p-10 flex justify-between items-center h-full">
                                                    ...
                                                    <div>
                                                        <img className="h-auto w-96" src="https://www.dropbox.com/s/8ymeus1n9k9bhpd/y16625.png?dl=1" alt="" />
                                                    </div>
                                                </article>
                                            </section>
                                            ...
                                            <section className="row-start-5 row-end-7 col-start-4 col-end-9 bg-gray-200">
                                                <article className="p-10 flex justify-between items-center h-full">
                                                    ...
                                                    <div>
                                                        <img className="h-auto w-full ml-10 -mt-5" src="https://www.dropbox.com/s/1fav310i2eqkdz8/tool2.png?dl=1" alt="" />
                                                    </div>
                                                </article>
                                            </section>
                                            <section className="row-start-1 row-end-4 col-start-9 col-end-13 bg-teal-100">
                                                <article className="p-10 flex justify-between items-center h-full">
                                                    ...
                                                    <div>
                                                        <img className="h-auto w-80" src="https://www.dropbox.com/s/mlor33hzk73rh0c/x14423.png?dl=1" alt="" />
                                                    </div>
                                                </article>
                                            </section>
                                            <section className="row-start-4 row-end-7 col-start-9 col-end-13 bg-purple-100">
                                                <article className="p-10 flex justify-between items-center h-full">
                                                    ...
                                                    <div>
                                                        <img className="h-auto w-80" src="https://www.dropbox.com/s/ykdro56f2qltxys/hh2774663-87776.png?dl=1" alt="" />
                                                    </div>
                                                </article>
                                            </section>
                                        </section>
                                    ...
                                    <section className="container mx-auto p-10 md:py-20 px-0 md:p-10 md:px-0">
                                        <section className="p-5 md:p-0 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 items-start ">
                                            <section className="p-5 py-12 text-left transform duration-500 hover:-translate-y-2 hover:shadow-2xl cursor-pointer">
                                                <img className="p-5" src="https://www.dropbox.com/s/r8845qrir3a2ote/580b585b2edbce24c47b2746.png?dl=1" alt="" />
                                            ...
                                            <section className="p-5 py-12 text-left transform duration-500 hover:-translate-y-2 hover:shadow-2xl cursor-pointer">
                                                <img className="p-5" src="https://www.dropbox.com/s/lscl1uc8fpsq2ul/580b585b2edbce24c47b274c.png?dl=1" alt="" />
                                                <h2 className="font-semibold mb-2 mt-12 text-cyan-600">Popular Collection</h2>
                                            ...
                                            <section className="p-5 py-12 text-left transform duration-500 hover:-translate-y-2 hover:shadow-2xl cursor-pointer relative">
                                                <img className="p-5" src="https://www.dropbox.com/s/vmtb36poyq3s7go/580b585b2edbce24c47b274a.png?dl=1" alt="" />
                                                <h2 className="font-semibold mb-2 mt-12 text-cyan-600">Popular Collection</h2>
                                                ...
                                                <p className="mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio, incidunt!</p>
                                                <h2 className="font-semibold mb-5">$38.50 <span className="ml-2 line-through text-gray-400">$50.00</span> </h2>
                                                <button className="p-2 px-6 bg-teal-500 text-white rounded-md hover:bg-teal-600">Add To Cart</button>
                                                <div className="sale absolute top-5 right-2 p-2 px-5 font-semibold bg-red-600 text-white uppercase">25% Off</div>
                                            </section>

                                            <section className="p-5 py-12 text-left transform duration-500 hover:-translate-y-2 hover:shadow-2xl cursor-pointer">
                                                <img className="p-5" src="https://www.dropbox.com/s/821jeb3xvke4mur/580b585b2edbce24c47b2749.png?dl=1" alt="" />
                                                <h2 className="font-semibold mb-2 mt-12 text-cyan-600">Popular Collection</h2>
                                    ...
                                    <section className="container mx-auto p-10 md:py-20 px-0 md:p-10 md:px-0">
                                        <section className="p-5 md:p-0 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 items-start ">
                                            <section className="p-5 py-10 text-left transform duration-500 hover:-translate-y-1 hover:shadow-xl cursor-pointer bg-gray-100">
                                                <img className="w-20 " src="https://www.dropbox.com/s/f3vre0tmd7i4wi1/66847-logo-google-telegram-drive-suite-free-hd-image.png?dl=1" alt="" />
                                                ...
                                                <button className="mt-10 p-2 px-6 bg-blue-500 text-white rounded-md hover:bg-blue-600">Add Storage</button>
                                            </section>

                                            <section className="p-5 py-10 text-left transform duration-500 hover:-translate-y-1 hover:shadow-xl cursor-pointer bg-gray-100">
                                                <img className="w-20 " src="https://www.dropbox.com/s/yo8tx7whbcol2it/62455-icons-storage-computer-user-file-dropbox-airdrop.png?dl=1" alt="" />
                                            ...
                                            <section className="p-5 py-10 text-left transform duration-500 hover:-translate-y-1 hover:shadow-xl cursor-pointer bg-gray-100">
                                                <img className="w-20 " src="https://www.dropbox.com/s/8n3xi891qp5mx0j/mega-icon.png?dl=1" alt="" />
                                            ...
                                            <section className="p-5 py-10 text-left transform duration-500 hover:-translate-y-1 hover:shadow-xl cursor-pointer bg-gray-100">
                                                <img className="w-28 " src="https://www.logo.wine/a/logo/OneDrive/OneDrive-Logo.wine.svg" alt="" />
                                        ...
                                        <section className="p-5 md:p-0 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 items-start ">
                                            <article className="p-5 transform duration-300 hover:-translate-y-1 cursor-pointer  hover:shadow-2xl group">
                                                <div className="relative max-h-125 overflow-hidden">
                                                    <img className="absolute" src="https://images.unsplash.com/flagged/photo-1571837360114-edf5dba7b1dd?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80" alt="" />
                                                    <img className="relative transform duration-500 group-hover:opacity-0" src="https://images.unsplash.com/photo-1579612635567-e45dc47a0985?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80" alt="" />
                                                </div>
                                            ...
                                            <article className="p-5 transform duration-300 hover:-translate-y-1 cursor-pointer  hover:shadow-2xl group">
                                                <div className="relative max-h-125 overflow-hidden">
                                                    <img className="absolute" src="https://images.unsplash.com/photo-1526411803240-adf6120a86e4?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=932&q=80" alt="" />
                                                    <img className="relative transform duration-500 group-hover:opacity-0" src="https://images.unsplash.com/photo-1527189919029-aeb3d997547d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=932&q=80" alt="" />
                                                </div>
                                                <div className="p-4 absolute bg-gray-200 rounded-full top-10 right-10 transform duration-500 opacity-0 group-hover:opacity-100">
                                            ...
                                            <article className="p-5 transform duration-300 hover:-translate-y-1 cursor-pointer  hover:shadow-2xl group">
                                                <div className="relative max-h-125 overflow-hidden">
                                                    <img className="absolute" src="https://images.unsplash.com/photo-1606763106075-85bfbe11e07f?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80" alt="" />
                                                    <img className="relative transform duration-500 group-hover:opacity-0" src="https://images.unsplash.com/photo-1606763106198-4ffc663c2419?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80" alt="" />
                                                </div>
                                                <div className="p-4 absolute bg-gray-200 rounded-full top-10 right-10 transform duration-500 opacity-0 group-hover:opacity-100">
                                            ...
                                            <article className="p-5 transform duration-300 hover:-translate-y-1 cursor-pointer  hover:shadow-2xl group">
                                                <div className="relative max-h-125 overflow-hidden">
                                                    <img className="absolute" src="https://images.unsplash.com/photo-1592182384017-d88cbb6c912d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80" alt="" />
                                                    <img className="relative transform duration-500 group-hover:opacity-0" src="https://images.unsplash.com/photo-1598062548091-a6fb6a052562?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80" alt="" />
                                                </div>
                                                <div className="p-4 absolute bg-gray-200 rounded-full top-10 right-10 transform duration-500 opacity-0 group-hover:opacity-100">
                                                    <a target="_blank" href="https://unsplash.com/@guilhermestecanella">
                                                        <svg className="w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="rgba(0,0,0,0.5)">
